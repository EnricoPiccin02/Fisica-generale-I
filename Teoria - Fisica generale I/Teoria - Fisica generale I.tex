...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[scale=1]
    ...
    \draw [-stealth] (start) -- (m_2) node[midway, below right]{$\vec r_2$};
    \draw [dashed] (m_1) -- coordinate[midway](mid) (m_2);
    \draw [-stealth, thick] (0,0) -- (mid) node[midway, above left]{$\vec r_{CM}$};
  \end{tikzpicture}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \draw[<->] (M1)++(0,-0.6) --++ (1.4*\xmax,0) node[midway,fill=white,inner sep=1] {$l$};
...
\begin{figure}[H]
  \centering
  \begin{tikzpicture}
    \draw[thick,-stealth,blue] (0,0) node[circ, blue]{} -- ++(2,0) node[midway,below]{$\vec p_{1,i}$} (5,0) node[circ]{} -- ++(-2,0) node[midway,below]{$\vec p_{2,i}$};
  \end{tikzpicture}
  \hspace{1em}
  \begin{tikzpicture}
    \draw[thick,-stealth,green] (2,0) node[circ]{} -- ++(-2,0) node[midway,below]{$\vec p_{1,f}$} (3,0) node[circ]{} -- ++(2,0) node[midway,below]{$\vec p_{2,f}$};
  \end{tikzpicture}
