...
allora si ha che la quantità di moto del centro di massa si conserva, ovvero $\vec p_{\text{CM}}$ è costante: tale risultato prende il nome di \textbf{conservazione della qantità di moto}.
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \draw[-stealth] (3,0) -- ++(1,0) node[midway,above]{$2$};
...
\[\left\{
    \begin{array}{l}
      \text{asse è fisso}\\
      \text{oppure}\\
      \text{asse passa per il centro di massa}
    \end{array}
\right.\]
