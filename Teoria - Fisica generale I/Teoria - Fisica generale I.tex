...
che permette di ottenere
\[K=\frac{1}{2}M v_{\text{CM}}^2 + \frac{1}{2}\sum_i m_i v_i'^2 + \vec v_{\text{CM}} \cdot \hspace{-4em} \underbrace{\sum_i m_i \cdot \vec v_i}_{0 \text{ perché } \vec p_{\text{tot}} \text{ nel centro di massa}}\]
