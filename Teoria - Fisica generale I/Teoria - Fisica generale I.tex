...
ove $\omega$ prende il nome di velocità angolare
...
A partire da tale risultato si sarebbe potuto determinare il modulo dell'accelerazione, semplicemente procedendo per derivate successive, ottenendo
\[\boxed{\vec{a}(t) = -\omega^2 \cdot \vec{r}(t)}\]
Se ora si procede al calcolo del modulo di tale vettore si ottiene
\[\boxed{\left \vert \vec{a} \right \vert = \omega^r \cdot R = \frac{v^2}{R}}\]
dal momento che è not che
\[\boxed{v = \omega T}\]
...
\begin{tabularx}{\textwidth}{P}
  {
      ...
      \begin{tikzpicture}
        ...
        {0.5 * x};
        \draw [-stealth, thick, red] (axis cs:0,0) -- (axis cs:5,2.5);
        \end{axis}
    \end{tikzpicture}
  }
\end{tabularx}
